...
def _build_llm() -> OpenAI:
    ...
    model = os.environ.get("CHRONOGRAPH_EXTRACTION_MODEL", "gpt-4o-mini")
    return OpenAI(model=model, api_key=api_key, temperature=0)


def extract_from_entry(entry: SourceEntry, llm: OpenAI) -> EntryExtraction:
